...
@section('content')
    ...
    <x-adminlte-card theme="primary" theme-mode="outline" title="Adicionar Produto" class="card-widget ">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-8">
                    <div class="row">
                        ...
                        {{-- Product Name --}}
                        <x-adminlte-input name="name" label="* Nome" placeholder="Nome do Produto" label-class="text-lightblue" fgroup-class="col-12"/>

                        {{-- Product Code --}}
                        <x-adminlte-input name="product_code" label="Código" label-class="text-lightblue" placeholder="Código do Produto" label-class="text-lightblue" fgroup-class="col-12 col-sm-4"/>
                        ...
                        {{-- Product Price --}}
                        <x-adminlte-input name="price_buy" label="Preço de Compra" label-class="text-lightblue" placeholder="Preço de compra" label-class="text-lightblue" class="currency" fgroup-class="col-12 col-sm-3"/>

                        {{-- Product Price Sale --}}
                        <x-adminlte-input name="price_sale" label="Preço de Venda" label-class="text-lightblue" placeholder="Preço de venda" label-class="text-lightblue" class="currency" fgroup-class="col-12 col-sm-3"/>
